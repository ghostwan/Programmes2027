import { AnswersMap, Party, PartyId, Proposition, ThemeId } from "@/lib/types";
 ...
 * AND that the user actually answered (pour/contre, skips excluded). The
 * match percent is the share of those the user answered "pour" on.
 * This avoids assuming a party opposes a proposition it simply has no
 * documented position on.
 */
